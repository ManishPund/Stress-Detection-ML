...
class UserRegistrationModel(models.Model):
    ...
    address = models.CharField(unique=False,max_length=1000)
    city = models.CharField(unique=False,max_length=100)
    state = models.CharField(unique=False,max_length=100)
    status = models.CharField(unique=False,max_length=100)
