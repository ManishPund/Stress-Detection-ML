...
urlpatterns = [
    ...
    path("UploadImageForm/", usr.UploadImageForm, name="UploadImageForm"),  # Page for image upload form
    path("UploadImageAction/", usr.UploadImageAction, name="UploadImageAction"),  # Handle image upload action
    path("ResultsTable/", usr.ResultsTable, name="ResultsTable"),  # Page for the results table
